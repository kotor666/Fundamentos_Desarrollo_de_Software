...
public class GUIProducts extends javax.swing.JFrame {
    ...
    private void txtCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCategoryActionPerformed
        ...
        String productCategory = String.parseString(txtCategory.getText());
        Product prod = productService.findProductByCategory(productCategory);
        if (prod == null) {
            Messages.showMessageDialog("La categoria del producto no existe", "Error");
            txtId.setText("");
            txtId.requestFocus();
        } else {
