...
public class GUIProductsFind extends javax.swing.JDialog {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (rdoId.isSelected()){
        Product p=productService.findProductById(Long.parseLong(txtSearch.getText()));
       ...
       // Product p=productService.findProductByName((txtSearch.getText()));
        //List<Product> productos = new ArrayList<>();
        //productos.add(p);
       ...
       // Product p=productService.findProductByName((txtSearch.getText()));
        //List<Product> productos = new ArrayList<>();
        //productos.add(p);
         fillTable(productService.findProductByCategory(txtSearch.getText()));
        }
